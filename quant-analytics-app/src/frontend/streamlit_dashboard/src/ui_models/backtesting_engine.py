...
@dataclass
class BacktestingQueryInput:
    market_query: MarketQueryInput
    backtesting: BacktestingInputs
    ...
    def to_query_params(self) -> Dict[str, Any]:
        ...
        params: Dict[str, Any] = {
            ...
            "initial_capital": self.backtesting.capital,
            "fast_window": self.backtesting.fast_window,
            "slow_window": self.backtesting.slow_window,
        }
